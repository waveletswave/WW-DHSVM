...
class ManagerMODISAppEEARS(manager_dataset.ManagerDataset):
    ...
    username and password in your .ww_dhsvmrc file.  For
    ...
    def _authenticate(self,
        ...
        username : string, optional
          Username, defaults to value from ww_dhsvmrc,
        ...
        """
        if username == None:
            username = ww_dhsvm.config.rcParams['AppEEARS']['username']
        if password is None:
            password = ww_dhsvm.config.rcParams['AppEEARS']['password']

        if username == "NOT_PROVIDED" or password == "NOT_PROVIDED":
            raise ValueError(
                "Username or password for AppEEARS are not set in ww_dhsvmrc.")
