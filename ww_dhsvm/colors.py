...
import ww_dhsvm.sources.manager_nlcd

createNLCDColormap = _createColormapCreator('NLCD', ww_dhsvm.sources.manager_nlcd.colors)

import ww_dhsvm.sources.manager_modis_appeears

createMODISColormap = _createColormapCreator(
    'MODIS', ww_dhsvm.sources.manager_modis_appeears.colors)
